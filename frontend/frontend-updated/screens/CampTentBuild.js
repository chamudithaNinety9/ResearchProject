  ...
  const TentProcess = () => {
    if (
      ...
      fetch(Base_url + "/tentSafety", {
        ...
        .then((data) => {
          setIsLoading(false);
          Alert.alert("Safety Rating", data.Safety_Rating);
      ...
      <View style={styles.container}>
        ...
        <View style={styles.greenBox}>
          <Text style={styles.selectLocationText}>
            Select Location for Camping Tent Build
          </Text>
          <Text style={styles.question}>Soil Condition</Text>
          <Picker
            selectedValue={soil}
            style={styles.dropdown}
            onValueChange={(itemValue, itemIndex) => setSoil(itemValue)}
          >
          ...
          <Picker
            selectedValue={land}
            style={styles.dropdown}
            onValueChange={(itemValue, itemIndex) => setLand(itemValue)}
          >
            <Picker.Item label="Select One" value="" />
          ...
          <Picker
            ...
            style={styles.dropdown}
            onValueChange={(itemValue, itemIndex) => setInsect(itemValue)}
          >
            <Picker.Item label="Select One" value="" />
          ...
          <Picker
            ...
            style={styles.dropdown}
            onValueChange={(itemValue, itemIndex) => setTerrain(itemValue)}
          >
            <Picker.Item label="Select One" value="" />
          ...
          <Picker
            ...
            style={styles.dropdown}
            onValueChange={(itemValue, itemIndex) => setWeather(itemValue)}
          >
            <Picker.Item label="Select One" value="" />
          ...
          <Picker
            selectedValue={wind}
            style={styles.dropdown}
            onValueChange={(itemValue, itemIndex) => setWind(itemValue)}
          >
            <Picker.Item label="Select One" value="" />
            <Picker.Item label="High" value="1" />
