...
model = footprint_defect_detector()
def create_transfer_model():
    ...
    model = tf.keras.Sequential([
        ...
        tf.keras.layers.Dense(3, activation='softmax')  # Three classes: fox, leopard, wildboar
    ])
...
if not os.path.exists('models/footprintNew-detector.h5'):
    model.save('models/footprintNew-detector.h5')
